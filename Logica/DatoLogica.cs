    ...
    public class DatoLogica
    {
        ...
        public Datos Obtener()
        {
            ...
            try
            {
                ...
                {
                    conexion.Open();
                    string query = "SELECT IdDato, RazonSocial, NIT, Direccion FROM DATOS WHERE IdDato = 1";
        ...
        public int Guardar(Datos objeto, out string mensaje)
        {
            ...
            try
            {
                using (SQLiteConnection conexion = new SQLiteConnection(Conexion.cadena))
                {
                    ...
                    cmd.Parameters.Add(new SQLiteParameter("@pnit", objeto.NIT));
